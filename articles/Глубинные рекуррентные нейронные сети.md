...
The depth-gated LSTM is illustrated in Fig. 4. It has a depth gate that connects the memory cells $c_{t}^(L+1)} in the upper layer L + 1 and the memory cell c L t in the lower layer L. The depth-gate controls
